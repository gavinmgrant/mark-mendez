...
function FeatureCard({ card }: FeatureCardProps) {
  ...
  return (
    <div className="rounded-2xl bg-accent p-8 md:min-h-[300px] md:p-8">
      <span className="mb-9 flex w-fit p-3 items-center justify-center rounded-full bg-background">
